...
if ($edit_id) {
    ...
    mysqli_stmt_bind_result($st, $n, $fa);
...
<head>
    <meta charset="utf-8">
    <title>Tambah/Edit Prodi</title>
    <link rel="stylesheet" href="style.css">
</head>

<body>
    <div class="container">
        <h2><?= $edit_id ? "Edit Prodi" : "Tambah Prodi" ?></h2>
        <?php if ($msg)
