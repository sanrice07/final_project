...
<head>
  ...
  <style>
    .info{margin-bottom:12px;padding:10px;border-radius:8px;background:#fff7e6;border:1px solid #f0d8b7}
    .error{background:#fff0f0;border:1px solid #f0b7b7;color:#7a1b1b;padding:10px;border-radius:8px}
