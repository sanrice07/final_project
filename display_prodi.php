...
?>
<!doctype html><html><head><meta charset="utf-8"><title>Prodi</title>
<link rel="stylesheet" href="style.css"></head><body>
<div class="container"><h2>Daftar Prodi</h2><a class="btn" href="add_prodi.php">Tambah Prodi</a>
<?php
if (!$res) echo "<div class='msg error'>Error: ".htmlspecialchars(mysqli_error($con))."</div>";
else {
  if (mysqli_num_rows($res)===0) echo "<div class='msg'>Belum ada data.</div>";
    ...
    while($r=mysqli_fetch_assoc($res)){
      $id=$r['id_prodi']; $np=htmlspecialchars($r['nama_prodi']); $f=htmlspecialchars($r['fakultas']);
